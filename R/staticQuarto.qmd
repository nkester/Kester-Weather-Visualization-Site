...
# Select local when you want to read from a local .RDS file previously created 
#  when updating from the local database. This will not change until we get the
#  cloud database integration working.
# Select update when you want to connect to the database and pull new data. This
